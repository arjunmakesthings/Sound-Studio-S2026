        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "bang", "" ],
                    "patching_rect": [ 735.0, 577.0, 47.0, 29.0 ],
                    "text": "sel 1"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 724.0, 29.0, 32.0, 29.0 ],
                    "text": "t l l"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 402.0, 76.0, 129.0, 27.0 ],
                    "text": "< open camera"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 347.0, 75.0, 49.0, 29.0 ],
                    "text": "open"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "jit_matrix", "" ],
                    "patching_rect": [ 248.0, 133.0, 222.0, 29.0 ],
                    "text": "jit.grab 320 180 @format 1"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 30.0, 319.0, 157.0, 167.0 ],
